...
Figure 8: Methane Generation Potential v.s. Population in California

Figure 9: Organic Waste Methane Generation Potential

Figure 10: Animal Manure Methane Generation Potential

Figure 11: Waste Water Methane Generation Potential

Figure 12: Landfill Potential Methane Generation Potential 

Figure 13: Total Methane Generation Potential v.s. Poor Population in California

Figure 14: Landfill CH4 Generation Potential v.s. Poor Population in California

Figure 15. Wastewater CH4 Potential v.s. Poor Population in California

Figure 16. Organic Waste CH4 Potential v.s. Poor Population in California

Figure 17. Manure CH4 Potential v.s. Poor Population in California
...
Plot_pop_CH4 <- 
  ...
  ggtitle("Figure 8. Methane Generation Potential v.s. Population in California")+
  mytheme
  print(Plot_pop_CH4)  

```

Correlation test: 0.819

p-value:4.22e-15

The null hypothesis to our research question is that there is no correlation between population density and biogas generation potential. We ran a correlation test to test the strength and direction between California population and the total biogas generation potential. We also ran a simple linear regression model to investigate whether these two variables involves a linear relationship. By looking at the residual plots, we can tell that the regression model fits our data but has outliers that disrupt the model accuracy. The p-value is 4.22e-15, indicating that the result is statistically significant.  Therefore, we are confident in rejecting the null hypothesis. 
...
OW_Plot <- 
  ...
  ggtitle("Figure 9. Organic Waste Methane Generation Potential")+
  mytheme
print(OW_Plot)
...
AM_Plot <- 
  ...
  ggtitle("Figure 10.Animal Manure Methane Generation Potential")+
  mytheme
print(AM_Plot)
...
WWTP_Plot <- 
  ...
  ggtitle("Figure 11. Waste Water Methane Generation Potential")+
  mytheme
print(WWTP_Plot)
...
LF_Plot <- 
  ...
  ggtitle("Figure 12. Landfill Potential Methane Generation Potential")+
  mytheme
print(LF_Plot)
...
Correlation test: 0.79

p-value:< < 1.926e-13

Now we can say the total biogas generation potential in california does have a linear relationship with the population density. However, we still want to know how and what different sources is correlated with population. Subsequently, we ran the same test for each individual biogas sources. We found out the the organic waste and wastewater contributes to the highest correlation to the population density, while Animal manure and landfill are less correlated. 
...
Plot_poor_CH4 <- 
  ...
  ggtitle("Figure 13. Total Methane Generation Potential v.s. Poor Population in California")+
  mytheme
  print(Plot_poor_CH4) 
```

Correlation test: 0.82
...
Plot_poor_LF <- 
  ...
  ylim(0, 750000)+
  labs(y= "Population Density", x = "Methane Generation Potential")+
  ggtitle("Figure 14. Landfill CH4 Generation Potential v.s. Poor Population in California")+
  mytheme
  print(Plot_poor_LF) 
```

Correlation test: 0.78
...
Plot_poor_WW <- 
  ...
  ylim(0, 750000)+
  labs(y= "Population Density", x = "Methane Generation Potential")+
  ggtitle("Figure 15. Wastewater CH4 Potential v.s. Poor Population in California")+
  mytheme
  print(Plot_poor_WW) 
```

Correlation test: 0.97
...
Plot_poor_OW <- 
  ...
  ylim(0, 750000)+
  labs(y= "Population Density", x = "Methane Generation Potential")+
  ggtitle("Figure 16. Organic Waste CH4 Potential v.s. Poor Population in California")+
  mytheme
  print(Plot_poor_OW)
```

Correlation test: 0.98
...
Plot_poor_AM <- 
  ...
  ylim(0, 400000)+
  labs(y= "Population Density", x = "Methane Generation Potential")+
  ggtitle("Figure 17. Manure CH4 Potential v.s. Poor Population in California")+
  mytheme
print(Plot_poor_AM)
```
...
Lastly, we investigated whether these four sources are associated with poor areas. We did similar linear regression for four methane generation sources and it turns out that they all are positively correlated with impoverished population. Similarly, high correlation falls into organic waste and wastewater and lower correlation with animal manure.
